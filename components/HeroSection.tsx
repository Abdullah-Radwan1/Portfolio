    ...
    <section className="lg:py-16">
      <div className=" grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <h1 className=" mb-8 text-4xl sm:text-5xl lg:text-8xl  font-extrabold">
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 text-white inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-200 "
            >
              Hire Me
            </Link>
            <Link
              ...
              href="/Abdullah.pdf"
              className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-transparent border border-[#ADB7BE] mt-3 hover:bg-muted transition-all duration-300"
            >
